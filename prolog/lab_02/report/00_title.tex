\begin{table}[ht]
	...
	\begin{tabular}{|c|p{400pt}|} 
		\hline
		\begin{tabular}[c]{@{}c@{}}
			\includegraphics[scale=0.37]{images/bmstu_eblem.png} \\\end{tabular} &
...
\begin{center}
	\vspace{2cm}
	{\bf\huge Отчёт\par}
	{\bf\Large по лабораторной работе №1, 2\par}
	\vspace{0.5cm}
\end{center}
...
\makebox[\textwidth][l]{\large\underline{~Структура и работа программы на Prolog.~~~}}\\
